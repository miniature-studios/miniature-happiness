...
namespace Utils
{
    public class MissingScriptUtility : EditorWindow
    {
        ...
        {
            _ = EditorWindow.GetWindow(typeof(MissingScriptUtility));
        }

        public void OnGUI()
        {
            string includeInactiveTooltip =
        ...
        {
            List<GameObject> selections = new();
        ...
        public static void RemoveMissingScripts(GameObject[] gameObjects)
        {
            ...
            foreach (GameObject gameObject in gameObjects)
            {
                ...
                if (count > 0)
                {
                    ...
                    _ = GameObjectUtility.RemoveMonoBehavioursWithMissingScript(gameObject);
