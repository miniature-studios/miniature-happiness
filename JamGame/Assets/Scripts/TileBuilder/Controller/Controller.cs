...
namespace TileBuilder
{
    ...
    public class Controller : MonoBehaviour
    {
        ...
        public UnityEvent<Level.Inventory.Room.MenuView> JustAddedUI; // FIXME
        ...
        public void PointerOverView(bool over)
        {
            if (over)
            {
                Level.Inventory.Room.MenuView destroyed_tile_ui_prefab = null;
        ...
        private Result TryPlace(Level.Inventory.Room.MenuView room_inventory_ui)
        {
            Ray ray = Camera.main.ScreenPointToRay(Input.mousePosition);
